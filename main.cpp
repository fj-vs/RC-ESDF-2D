...
public:
    EsdfPlannerNode() : nh_("~") {
        ...
        nh_.param("mpc_w_x", mpc_cfg.w_x, mpc_cfg.w_x);
        nh_.param("mpc_w_y", mpc_cfg.w_y, mpc_cfg.w_y);
        nh_.param("mpc_w_yaw", mpc_cfg.w_yaw, mpc_cfg.w_yaw);
        nh_.param("mpc_w_v", mpc_cfg.w_v, mpc_cfg.w_v);
        nh_.param("mpc_w_w", mpc_cfg.w_w, mpc_cfg.w_w);
        nh_.param("mpc_w_du", mpc_cfg.w_du, mpc_cfg.w_du);
